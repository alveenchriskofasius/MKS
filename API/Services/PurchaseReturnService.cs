...
public class PurchaseReturnService : IPurchaseReturnService
{
    ...
    public Task<object> GetApprovedPOsForReturn() => _repo.GetApprovedPOsForReturn();
    public Task<object> GetPOItemsForReturn(int poId) => _repo.GetPOItemsForReturn(poId);
}
